...
const tableGuests: Record<number, string[]> = {
  ...
  3: ['Akshat Khanna', 'Akshita Khanna', 'Alicia Kacharia', 'Natasha Kacharia', 'Rohin Meduri', 'Spursh Kacharia', 'Reeteka Kudallur', 'Saransh Kacharia'],
  4: ['Chaitanya Agrawal', 'Harsh Agrawal', 'Kahini Sapra', 'Meghavi Singhania', 'Vaibhav Agarwal', 'Arpit Ranasaria', 'Ronak Agarwal'],
  5: ['Priya Rastogi', 'Pooja Rastogi', 'Anushka Jain', 'Deeksha Gupta', 'Sachita Gupta', 'Nirvika Gupta'],
  6: ['Anjali Amin', 'Yash Amin', 'Siya Jani', 'Deyan Jani', 'Rhidaya Bhoot', 'Manya Tayal', 'Shrey Tayal'],
  7: ['Annam Khan', 'Hannah Wiseman', 'Cindy Deng', 'Deepak Pallerla', 'Jade Traiger', 'Ricky Hage'],
